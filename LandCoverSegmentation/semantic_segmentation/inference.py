...
def get_inference_loader(image_path, label_path=None, model_input_size=64, num_classes=4,
...
def run_inference(args):
    ...
    save_path = '/home/annus/Desktop/palsar/generated_maps/using_separate_models/' \
